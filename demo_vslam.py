...
if __name__ == '__main__':
    ...
    if args.out_traj_prefix is not None:
        ...
        out_slamtrajfn = args.out_traj_prefix + '_stamped_traj_estimate.txt'
        if cfg.LOOP_CLOSURE:
            out_slamtrajfn = args.out_traj_prefix + '_stamped_traj_estimate_with_loopclosure.txt'
